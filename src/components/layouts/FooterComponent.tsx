                    ...
                    <>
                        <div className={`row pt-3`}>
                            ...
                            <div className="mb-3 col-4 text-center" onClick={() => navigateTo('/itsm/incident-request')}>
                                <i className={`footer-icon bx bxs-notepad ${(currentPage === '/itsm/incident-request' || currentPage === '/itsm/incident&request') ? 'animate__animated animate__rubberBand' : ''}`}></i> <br />
                                <span className={`badge badge-dot ${(currentPage === '/itsm/incident-request' || currentPage === '/itsm/incident&request') ? 'bg-primary animate__animated animate__wobble' : ''}`}></span>
                        </div>
